...
export default class Home extends React.Component {
  render() {
    return (
      <View style={{ flex: 1,}}>
        <Navbar />
        <View style={{ marginTop: 10, marginHorizontal: 5, flex: 1, borderTopWidth: 2, borderColor: '#EEEEEE'}}>
          <View style={{ flex: 1, flexDirection: 'row', paddingTop: 10 }}>
            ...
            <View style={{ flex: 6 }}>
              <Text style={{ fontWeight: 'bold', fontSize: 20, color: '#424242' }}>
                Ishab Redmen
              </Text>
              <View >
          ...
          <View style={{ flex: 2, backgroundColor:'#E0E0E0'}}>
            ...
            <ScrollView horizontal style={{paddingTop:20}}>
              {
                discount.map((dis, key) => <DiscountCoupon label={dis.label} subLabel={dis.subLabel} coupon={dis.coupon} style={dis.style} key={key} />)
              }
            </ScrollView>
          </View>
          <View style={{ flex: 3, backgroundColor:'#F5F5F5',borderTopWidth:2,borderTopColor:'#fff'}}>
            <Text style={{ color: '#757575', backgroundColor: '#E0E0E0'}}>
              Your Orders!
            </Text>
